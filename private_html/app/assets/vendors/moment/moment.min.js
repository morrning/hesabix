! function (e, t) {
    ...
    var Te = "ژانویه_فوریه_مارس_آپریل_مه_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
        Ne = "ژانویه_فوریه_مارس_آپریل_مه_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
        Pe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        Re = de,
        We = de;
    ...
    var Ze = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
        ze = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
        $e = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
        qe = de,
        Be = de,
        Je = de;
