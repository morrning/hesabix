    ...
    var e, t, r, n = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        ...
        P = function (o, e) {
            ...
            return k({
                ...
                start: function (e, t) {
                    if (!c.get())
                        if (j(t.map, "data-ephox-embed-iri")) c.set(!0), i = (n = t).map.style, a = i ? T.parseStyle(i) : {}, u = {
        ...
        E = function (e, c, u) {
            ...
            return k({
                ...
                start: function (e, t, r) {
                    if (!m.get())
                        if (j(t.map, "data-ephox-embed-iri")) m.set(!0), n = c, a = (i = t).map.style, (o = a ? M.parseStyle(a) : {})["max-width"] = z(n.width), o["max-height"] = z(n.height), N(i, {
        ...
        ee = function (m) {
            var e, t, r, n, i = (r = (e = m).selection.getNode(), n = (t = r).getAttribute("data-mce-object") || t.getAttribute("data-ephox-embed-iri") ? e.serializer.serialize(r, {
                    selection: !0
                }) : "", p({
                    embed: n
                }, P(O(e), n))),
                ...
                f = m.windowManager.open({
                    ...
                    onChange: function (e, t) {
                        switch (t.name) {
                            ...
                            case "altsource":
                            case "poster":
                                r = e, n = t.name, i = J(r.getData(), n), a = I(m, i), r.setData(K(p(p({}, i), {
                                    embed: a
                                })))
                        }
        ...
        ie = function (e, t, r) {
            var n, i, a, o, c;
            for (o = (a = t.attributes).length; o--;) n = a[o].name, i = a[o].value, "width" !== n && "height" !== n && "style" !== n && ("data" !== n && "src" !== n || (i = e.convertURL(i, n)), r.attr("data-mce-p-" + n, i));
        ...
        oe = function (f) {
            return function (e) {
                for (var t, r, n, i, a, o, c, u, s, l, m, d, h = e.length; h--;)(t = e[h]).parent && (t.parent.attr("data-mce-object") || "script" === t.name && !(r = A(O(f), t.attr("src"))) || (r && (r.width && t.attr("width", r.width.toString()), r.height && t.attr("height", r.height.toString())), "iframe" === t.name && f.getParam("media_live_embeds", !0) && re.ceFalse ? ae(t) || t.replace((c = f, m = l = s = void 0, d = (u = t).name, (s = new te("span", 1)).attr({
                    contentEditable: "false",
                    style: u.attr("style"),
                    "data-mce-object": d,
                    "class": "mce-preview-object mce-object-" + d
                }), ie(c, u, s), (l = new te(d, 1)).attr({
                    src: u.attr("src"),
                    ...
                    frameborder: "0"
                }), (m = new te("span", 1)).attr("class", "mce-shim"), s.append(l), s.append(m), s)) : ae(t) || t.replace((n = f, a = void 0, o = (i = t).name, (a = new te("img", 1)).shortEnded = !0, ie(n, i, a), a.attr({
