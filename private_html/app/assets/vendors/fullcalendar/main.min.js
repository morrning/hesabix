...
var FullCalendar = function (e) {
    ...
    function Sr(e, t, n) {
        var r;
        if (void 0 === n && (n = Dr(t)), "string" == typeof e ? r = {
                url: e
    ...
    var Cr = function () {
        ...
        wr = function () {
            ...
            return e.prototype.setProp = function (e, t) {
                ...
                else if ("id" === e) t = Tn[e](t), this.mutate({
                    standardProps: {
                        publicId: t
                    }
                });
                else if (e in Tn) t = Tn[e](t), this.mutate({
    ...
    function Or(e) {
        for (var t = e.length > 0 ? e[0].code : "en", n = Nr.concat(e), r = {
                en: Hr
    ...
    var Jo = function () {
        ...
        return e.prototype.buildPrev = function (e, t, n) {
            ...
            return n || ((t = this.props.dateAlignment) ? xt(1, t) : e || xt({
                days: 1
            }))
    ...
    var Si = [Oo({
        ...
        propSetHandlers: {
            dateProfile: function (e, t) {
                t.emitter.trigger("datesSet", r(r({}, ur(e.activeRange, t.dateEnv)), {
                    view: t.viewApi
                }))
            },
    ...
    var _i = function () {
        ...
        return e.prototype.resetOptions = function (e, t) {
            ...
            var e, t, n, o, i, a, s, l, u, c = this.props,
                ...
                y = f.calendarOptions;
            if (m && m !== y)
                for (var E in m.timeZone !== y.timeZone && (d.eventSources = v.eventSources = (a = v.eventSources, s = d.dateProfile, l = v, u = s ? s.activeRange : null, oi(a, ai(a, l), u, !0, l)), d.eventStore = v.eventStore = (e = v.eventStore, t = p.dateEnv, n = v.dateEnv, o = e.defs, i = mt(e.instances, (function (e) {
                        var i = o[e.defId];
    ...
    var ta = function (e) {
        ...
        na = function (e) {
            ...
            return n(t, e), t.prototype.render = function () {
                var e, t, n = this.props,
                    ...
                    i = !1,
                    a = r.center;
                return r.left ? (i = !0, e = r.left) : e = r.start, r.right ? (i = !0, t = r.right) : t = r.end, yo("div", {
        ...
        aa = function (e) {
            ...
            return n(t, e), t.prototype.render = function () {
                ...
                return yo(To.Provider, {
                    value: l
                }, n.headerToolbar && yo(na, r({
                    ref: this.headerRef,
    ...
    function wa(e, t, n) {
        return !!Bn(t.validRange, e.range) && Ra({
            dateSelection: e
        }, n)
    }
    ...
    function _a(e, t, n, o) {
        return void 0 === n && (n = {}), !(e.eventDrag && ! function (e, t, n, o) {
            var i = t.getCurrentData(),
                ...
                l = s.defs,
                u = s.instances,
                c = Xn(l, a.isEvent ? e.eventUiBases : {
                    "": i.selectionConfig
                });
            o && (c = mt(c, o));
    ...
    function Wa(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++)
            for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1) n.push(yo("col", {
                style: {
    ...
    var Ya = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return "outerContent" in e ? yo(Do, {
                key: e.key
        ...
        Xa = function (e) {
            ...
            return n(t, e), t.prototype.render = function () {
                ...
                return yo(Za, {
                    ...
                    }, a), s.isStartResizable && yo("div", {
                        className: "fc-event-resizer fc-event-resizer-start"
                    }), s.isEndResizable && yo("div", {
            ...
            return o.isRendering = !1, o.isRendered = !1, o.currentClassNames = [], o.customContentRenderId = 0, o.handleAction = function (e) {
                ...
                if (o.isRendering) {
                    ...
                    Eo(yo(ua, {
                        ...
                        return o.setClassNames(t), o.setHeight(n), yo(Vo.Provider, {
    ...
    var gs = 0,
        ...
        Es = function () {
            function e(e) {
                ...
                }, this.containerEl = e, this.emitter = new co, e.addEventListener("mousedown", this.handleMouseDown), e.addEventListener("touchstart", this.handleTouchStart, {
                    passive: !0
                }), 1 === (ms += 1) && window.addEventListener("touchmove", Ss, {
                    passive: !1
                })
            }
            return e.prototype.destroy = function () {
                this.containerEl.removeEventListener("mousedown", this.handleMouseDown), this.containerEl.removeEventListener("touchstart", this.handleTouchStart, {
                    passive: !0
                }), (ms -= 1) || window.removeEventListener("touchmove", Ss, {
                    passive: !1
                })
    ...
    var Os = function (e) {
        function t(t) {
            ...
            n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function (e) {
                ...
                }), c ? Oe() : Ae(), t || (l && Ms(a, e) && (l = null), n.validMutation = l, n.mutatedRelevantEvents = u)
            }, n.handleDragEnd = function (e) {
                var t = n.component.context,
                    o = n.eventRange.def,
    ...
    var Sl = function (e) {
        ...
        bl = function (e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.allDaySplitter = new gl, t.headerElRef = So(), t.rootElRef = So(), t.scrollerElRef = So(), t.state = {
                    slatCoords: null
                ...
                return f.push({
                    ...
                    chunks: [{
                        ...
                        content: function (e) {
                            ...
                            }, e.tableColGroupNode, yo("tbody", null, yo(Sl, {
                                slatMetas: i
                            }))), yo("div", {
            ...
            return n(t, e), t.prototype.render = function () {
                ...
                return yo(ts, {
                    ...
                    return yo("td", r({
                        ...
                        className: "fc-timegrid-now-indicator-container"
                    }, e.renderNowIndicator(t.nowIndicatorSegs)), yo(Wl, {
                        date: t.date,
                        dateProfile: t.dateProfile,
                        todayRange: t.todayRange,
                        extraHookProps: t.extraHookProps
                ...
                var n = this.props,
                    ...
                    i = Al(e, n.date, n.slatCoords, o.options.eventMinHeight).map((function (o, i) {
                        ...
                        return yo("div", {
                            ...
                            seg: a
                        }, rr(a, n.todayRange, n.nowDate))) : ns(t))
                    }));
                return yo(Do, null, i)
    ...
    var Bl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            }, t.tableColGroupNode, yo("tbody", null, yo("tr", null, t.axis && yo("td", {
                className: "fc-timegrid-col fc-timegrid-axis"
            }, yo("div", {
                className: "fc-timegrid-col-frame"
            }, yo("div", {
                className: "fc-timegrid-now-indicator-container"
            }, "number" == typeof n && yo($a, {
                isAxis: !0,
                date: t.nowDate
            }, (function (e, t, r, o) {
                return yo("div", {
    ...
    var jl = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.processSlotOptions = zt(Gl), t.state = {
                slatCoords: null
    ...
    function tu(e) {
        ...
        return yo(Do, null, e.text && yo("a", r({
            className: "fc-list-day-text"
        }, t), e.text), e.sideText && yo("a", r({
    ...
    }, e.triggerDateSelect = pr, e.unmountComponentAtNode = Ro, e.unpromisify = uo, e.version = "5.9.0", e.whenTransitionDone = Ie, e.wholeDivideDurations = Ot, Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});