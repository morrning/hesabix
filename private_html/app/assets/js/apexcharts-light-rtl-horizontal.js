$(function () {
  ...
  if ($('#apexLine').length) {
    var lineChartOptions = {
      ...
      xaxis: {
        type: "datetime",
        categories: ["1397", "1398", "1399", "1400"],
        lines: {
          show: true
        },
        axisBorder: {
  ...
  if ($('#apexArea').length) {
    ...
    function generateDayWiseTimeSeries(s, count) {
      ...
      var i = 0;
      var series = [];
      var x = new Date("11 Nov 1400").getTime();
      while (i < count) {
  ...
  if ($('#apexMixed').length) {
    var options = {
      ...
      labels: ['01/01/1399', '02/01/1399', '03/01/1399', '04/01/1399', '05/01/1399', '06/01/1399', '07/01/1399', '08/01/1399', '09/01/1399', '10/01/1399', '11/01/1399'],
      markers: {
        size: 0
      },
      xaxis: {
  ...
  if ($('#apexRadar').length) {
    var options = {
      ...
      labels: ['1394', '1395', '1396', '1397', '1398', '1399'],
