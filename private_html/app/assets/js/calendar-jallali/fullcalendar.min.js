...
! function (t) {
    ...
    function i(t) {
        var e = [];
        for (var n in t) "boolean" != typeof t[n] && e.push(t[n]);
        return e
    }
    ...
    function r(t) {
        ...
        return t.toString().replace(/\d/g, function (t) {
            return e[t]
        }).replace(/,/g, "،")
    }

    function s(t, e) {
        return e ? t.replace(/j/g, "") : t
    }
    ...
    function l(e) {
        ...
        return t.each(e, function (e, r) {
            "views" != e && (t.isPlainObject(r) && !/(time|duration|interval)$/i.test(e) && -1 == t.inArray(e, qt) ? (n = null, t.each(r, function (t, r) {
    ...
    function f(e, n, i) {
        ...
        g(e), e.each(function (n, i) {
            var c = n === e.length - 1 ? s : r,
                d = t(i).outerHeight(!0);
            c > d ? (o.push(i), a.push(d), l.push(t(i).height())) : u += d
    ...
    function S(t) {
        var e = t.offset(),
            n = E(t),
            i = e.left + H(t, "border-left-width") + n.left,
            r = e.top + H(t, "border-top-width") + n.top;
        return {
            left: i,
    ...
    function b(t) {
        var e = t.offset(),
            n = e.left + H(t, "border-left-width") + H(t, "padding-left"),
            i = e.top + H(t, "border-top-width") + H(t, "padding-top");
        return {
            left: n,
            right: n + t.width(),
            top: i,
    ...
    function E(t) {
        ...
        return D() && "rtl" == t.css("direction") ? n.left = e : n.right = e, n
    }

    function D() {
        return null === Jt && (Jt = C()), Jt
    }
    ...
    function V(t, e) {
        var n, i, r;
        for (n = 0; n < Qt.length && (i = Qt[n], r = O(i, t, e), !(r >= 1 && ot(r))); n++);
        return i
    }
    ...
    function _(t, e, n) {
        var i;
        return j(n) ? (e - t) / n : (i = n.asMonths(), Math.abs(i) >= 1 && ot(i) ? e.diff(t, "months", !0) / i : e.diff(t, "days", !0) / n.asDays())
    }

    function A(t, e) {
        var n, i;
        return j(t) || j(e) ? t / e : (n = t.asMonths(), i = e.asMonths(), Math.abs(n) >= 1 && ot(n) && Math.abs(i) >= 1 && ot(i) ? n / i : t.asDays() / e.asDays())
    }

    function Y(t, n) {
        var i;
        return j(t) ? e.duration(t * n) : (i = t.asMonths(), Math.abs(i) >= 1 && ot(i) ? e.duration({
            months: i * n
        }) : e.duration({
            days: t.asDays() * n
        }))
    ...
    function ut(r, s, o) {
        ...
        r = i(r);
        var l, u, c, d, h = r[0],
            f = 1 == r.length && "string" == typeof h;
        return e.isMoment(h) ? (d = e.apply(null, r), dt(h, d)) : $(h) || void 0 === h ? d = e.apply(null, r) : (l = !1, u = !1, f ? ie.test(h) ? (h += "-01", r = [h], l = !0, u = !0) : (c = re.exec(h)) && (l = !c[5], u = !0) : t.isArray(h) && (u = !0), d = s || l ? e.utc.apply(e, r) : e.apply(null, r), l ? (d._ambigTime = !0, d._ambigZone = !0) : o && (u ? d._ambigZone = !0 : f && (d.utcOffset ? d.utcOffset(h) : d.zone(h)))), d._fullCalendar = !0, a && e.loadPersian(), d
    }
    ...
    function ct(t, n) {
        var i, r, s = !1,
            ...
            a = t.length,
            l = [];
        for (i = 0; a > i; i++) r = t[i], e.isMoment(r) || (r = Zt.moment.parseZone(r)), s = s || r._ambigTime, o = o || r._ambigZone, l.push(r);
    ...
    function ft(t, e) {
        return e && (t = t.replace(/(.*)(\bYY\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bYYYY\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bYYYYY\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bM\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bMM\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bMMM\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bMMMM\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bMMMMM\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bD\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bDD\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bDDD\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bDDDD\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bgg\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bgggg\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bggggg\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\byear\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bmonth\b)(.*)/g, "$1j$2$3"), t = t.replace(/(.*)(\bw\b)(.*)/g, "$1j$2$3"), t.match(/^j.*/g) || (t = "j" + t)), t
    }

    function gt(t, e, n) {
        return oe.format.call(t, ft(e, n)).replace(/j/g, "")
    }

    function pt(t, e, n) {
        return mt(t, bt(e, n), n)
    }

    function mt(t, e, n) {
        var i, r = "";
        for (i = 0; i < e.length; i++) r += vt(t, e[i], n);
        return r
    }

    function vt(t, e, n) {
        var i, r;
        return "string" == typeof e ? e : (i = e.token) ? ae[i] ? ae[i](t, n) : gt(t, i, n) : e.maybe && (r = mt(t, e.maybe, n), r.match(/[1-9]/)) ? r : ""
    }

    function yt(t, e, n, i, r, s) {
        var o;
        return t = Zt.moment.parseZone(t), e = Zt.moment.parseZone(e), o = (t.localeData || t.lang).call(t), n = o.longDateFormat(n) || n, i = i || " - ", wt(t, e, bt(n, s), i, r, s)
    }

    function wt(t, e, n, i, r, s) {
        var o, a, l, u, c = t.clone().stripZone(),
            d = e.clone().stripZone(),
            h = "",
            f = "",
            g = "",
            p = "",
            m = "";
        for (a = 0; a < n.length && (o = St(t, e, c, d, n[a], s), o !== !1); a++) h += o;
        for (l = n.length - 1; l > a && (o = St(t, e, c, d, n[l], s), o !== !1); l--) f = o + f;
        for (u = a; l >= u; u++) g += vt(t, n[u], s), p += vt(e, n[u], s);
        return (g || p) && (m = r ? p + i + g : g + i + p), h + m + f
    }

    function St(t, e, n, i, r, s) {
        var o, a;
        return "string" == typeof r ? r : (o = r.token) && (a = le[o.charAt(0)], a && n.isSame(i, ft(a, s))) ? gt(t, o, s) : !1
    }

    function bt(t, e) {
        return t = s(t, e), t in ue ? ue[t] : ue[t] = Et(t)
    }
    ...
    function Ct(t, e) {
        ...
        }), n.prototype = U(t.prototype), q(e, n.prototype), J(e, n.prototype), q(t, n), n
    }

    function Ht(t, e) {
        q(e.prototype || e, t.prototype)
    }

    function Tt(t, e) {
        return t || e ? t && e ? t.component === e.component && xt(t, e) && xt(e, t) : !1 : !0
    }
    ...
    function Pt(t) {
        ...
        if (void 0 === t.forwardPressure) {
            for (e = 0; e < i.length; e++) n = i[e], Pt(n), r = Math.max(r, 1 + n.forwardPressure);
            t.forwardPressure = r
        }
    }
    ...
    function _t(n, i) {
        ...
        function s() {
            Z = _.theme ? "ui" : "fc", n.addClass("fc"), _.isRTL ? n.addClass("fc-rtl") : n.addClass("fc-ltr"), _.theme ? n.addClass("ui-widget") : n.addClass("fc-unthemed"), W = t("<div class='fc-view-container'/>").prependTo(n), j = O.header = new jt(O, _), $ = j.render(), $ && n.prepend($), u(_.defaultView), _.handleWindowResize && (X = lt(f, _.windowResizeDelay), t(window).resize(X))
        }

        function a() {
            q && q.removeElement(), j.removeElement(), W.remove(), n.removeClass("fc fc-ltr fc-rtl fc-unthemed ui-widget"), X && t(window).unbind("resize", X)
        }
        ...
        function u(e) {
            it++, q && e && q.type !== e && (j.deactivateButton(q.type), N(), q.removeElement(), q = O.view = null), !q && e && (q = O.view = nt[e] || (nt[e] = O.instantiateView(e)), q.setElement(t("<div class='fc-view fc-" + e + "-view' />").appendTo(W)), j.activateButton(e)), q && (Q = q.massageCurrentDate(Q), q.displaying && Q.isWithin(q.intervalStart, q.intervalEnd) || l() && (q.display(Q), B(), b(), E(), v())), B(), it--
        }

        function c(t) {
            return l() ? (t && h(), it++, q.updateSize(!0), it--, !0) : void 0
        }
        ...
        function h() {
            J = "number" == typeof _.contentHeight ? _.contentHeight : "number" == typeof _.height ? _.height - ($ ? $.outerHeight(!0) : 0) : Math.round(W.width() / Math.max(_.aspectRatio, .5))
        }

        function f(t) {
            !it && t.target === window && q.start && c(!0) && q.trigger("windowResize", et)
        }
        ...
        function v() {
            !_.lazyFetching || K(q.start, q.end) ? y() : p()
        }
        ...
        function D(t, e) {
            q.select(O.buildSelectSpan.apply(O, arguments))
        }
        ...
        function H() {
            Q = q.computePrevDate(Q), u()
        }

        function T() {
            Q = q.computeNextDate(Q), u()
        }
        ...
        function I(t) {
            Q = O.moment(t).stripZone(), u()
        }

        function M(t) {
            Q.add(e.duration(t)), u()
        }

        function F(t, e) {
            var n;
            e = e || "day", n = O.getViewSpec(e) || O.getUnitViewSpec(e), Q = t.clone(), u(n ? n.type : null)
        }

        function z() {
            return O.applyTimezone(Q)
        }
        ...
        function P(t, e) {
            return void 0 === e ? _[t] : void(("height" == t || "contentHeight" == t || "aspectRatio" == t) && (_[t] = e, c(!0)))
        }

        function V(t, e) {
            var n = Array.prototype.slice.call(arguments, 2);
            return e = e || et, this.triggerWith(t, e, n), _[t] ? _[t].apply(e, n) : void 0
        }
        var O = this;
        O.initOptions(i || {});
        var _ = this.options;
        O.render = r, O.destroy = a, O.refetchEvents = g, O.reportEvents = w, O.reportEventChange = S, O.rerenderEvents = p, O.changeView = u, O.select = D, O.unselect = C, O.prev = H, O.next = T, O.prevYear = x, O.nextYear = R, O.today = k, O.gotoDate = I, O.incrementDate = M, O.zoomTo = F, O.getDate = z, O.getCalendar = L, O.getView = G, O.option = P, O.trigger = V;
        var A = U(Yt(_.lang));
        if (_.monthNames && (A._months = _.monthNames), _.monthNamesShort && (A._monthsShort = _.monthNamesShort), _.dayNames && (A._weekdays = _.dayNames), _.dayNamesShort && (A._weekdaysShort = _.dayNamesShort), null != _.firstDay) {
            var Y = U(A._week);
            Y.dow = _.firstDay, A._week = Y
        }
        A._fullCalendar_weekCalc = function (t) {
            return "function" == typeof t ? t : "local" === t ? t : "iso" === t || "ISO" === t ? "ISO" : void 0
        }(_.weekNumberCalculation), O.defaultAllDayEventDuration = e.duration(_.defaultAllDayEventDuration), O.defaultTimedEventDuration = e.duration(_.defaultTimedEventDuration), O.moment = function () {
            var t;
            return arguments = o(arguments, _.isJalaali), "local" === _.timezone ? (t = Zt.moment.apply(null, arguments), t.hasTime() && t.local()) : t = "UTC" === _.timezone ? Zt.moment.utc.apply(null, arguments) : Zt.moment.parseZone.apply(null, arguments), "_locale" in t ? t._locale = A : t._lang = A, t
        }, O.getIsAmbigTimezone = function () {
            return "local" !== _.timezone && "UTC" !== _.timezone
        }, O.applyTimezone = function (t) {
            if (!t.hasTime()) return t.clone();
            var e, n = O.moment(t.toArray()),
                i = t.time() - n.time();
            return i && (e = n.clone().add(i), t.time() - e.time() === 0 && (n = e)), n
        }, O.getNow = function () {
            var t = _.now;
            return "function" == typeof t && (t = t()), O.moment(t).stripZone()
        }, O.getEventEnd = function (t) {
            return t.end ? t.end.clone() : O.getDefaultEventEnd(t.allDay, t.start)
        }, O.getDefaultEventEnd = function (t, e) {
            var n = e.clone();
            return t ? n.stripTime().add(O.defaultAllDayEventDuration) : n.add(O.defaultTimedEventDuration), O.getIsAmbigTimezone() && n.stripZone(), n
        }, O.humanizeDuration = function (t) {
            return (t.locale || t.lang).call(t, _.lang).humanize()
        }, $t.call(O, _);
        var j, $, W, Z, q, J, X, Q, K = O.isFetchNeeded,
            tt = O.fetchEvents,
            et = n[0],
            nt = {},
            it = 0,
            rt = [];
        Q = null != _.defaultDate ? O.moment(_.defaultDate).stripZone() : O.getNow(), O.getSuggestedViewHeight = function () {
            return void 0 === J && d(), J
        }, O.isHeightAuto = function () {
            return "auto" === _.contentHeight || "auto" === _.height
        }, O.freezeContentHeight = N, O.unfreezeContentHeight = B, O.initialize()
    }
    ...
    function $t(n) {
        ...
        function s(e, n) {
            o(e, function (i) {
                ...
                if (n == A) {
                    if (i)
                        for (r = 0; r < i.length; r++) s = i[r], o = a ? s : y(s, e), o && j.push.apply(j, E(o));
                    Y--, Y || V(j)
                }
            })
        }
        ...
        function o(e, i) {
            var r, s, a = Zt.sourceFetchers;
            for (r = 0; r < a.length; r++) {
                if (s = a[r].call(z, e, N.clone(), B.clone(), n.timezone, i), s === !0) return;
                if ("object" == typeof s) return void o(s, i)
            }
            var l = e.events;
            if (l) t.isFunction(l) ? (z.pushLoading(), l.call(z, N.clone(), B.clone(), n.timezone, function (t) {
                i(t), z.popLoading()
            })) : t.isArray(l) ? i(l) : i();
            else {
                var u = e.url;
                if (u) {
                    ...
                    var g = t.extend({}, c || {}),
                        p = tt(e.startParam, n.startParam),
                        m = tt(e.endParam, n.endParam),
                        v = tt(e.timezoneParam, n.timezoneParam);
                    p && (g[p] = N.format()), m && (g[m] = B.format()), n.timezone && "local" != n.timezone && (g[v] = n.timezone), z.pushLoading(), t.ajax(t.extend({}, Te, e, {
                        data: g,
                        success: function (e) {
                            e = e || [];
                        ...
                        complete: function () {
                            K(f, this, arguments), z.popLoading()
                        }
                    }))
                } else i()
            }
        ...
        function h(t) {
            t.start = z.moment(t.start), t.end ? t.end = z.moment(t.end) : t.end = null, D(t, f(t)), V(j)
        }
        ...
        function p(t, e) {
            var n, i, r, s = y(t);
            if (s) {
                for (n = E(s), i = 0; i < n.length; i++) r = n[i], r.source || (e && (O.events.push(r), r.source = O), j.push(r));
                return V(j), n
            }
            return []
        }
        ...
        function m(e) {
            ...
            for (null == e ? e = function () {
                    ...
                    return t._id == n
                }), j = t.grep(j, e, !0), i = 0; i < _.length; i++) t.isArray(_[i].events) && (_[i].events = t.grep(_[i].events, e, !0));
            V(j)
        }
        ...
        function y(i, r) {
            var s, o, a, l = {};
            if (n.eventDataTransform && (i = n.eventDataTransform(i)), r && r.eventDataTransform && (i = r.eventDataTransform(i)), t.extend(l, i), r && (l.source = r), l._id = i._id || (void 0 === i.id ? "_fc" + xe++ : i.id + ""), i.className ? "string" == typeof i.className ? l.className = i.className.split(/\s+/) : l.className = i.className : l.className = [], s = i.start || i.date, o = i.end, W(s) && (s = e.duration(s)), W(o) && (o = e.duration(o)), i.dow || e.isDuration(s) || e.isDuration(o)) l.start = s ? e.duration(s) : null, l.end = o ? e.duration(o) : null, l._recurring = !0;
            else {
                if (s && (s = z.moment(s), !s.isValid())) return !1;
                o && (o = z.moment(o), o.isValid() || (o = null)), a = i.allDay, void 0 === a && (a = tt(r ? r.allDayDefault : void 0, n.allDayDefault)), w(s, o, a, l)
            }
            return l
        }
        ...
        function S(t) {
            b(t), t.end && !t.end.isAfter(t.start) && (t.end = null), t.end || (n.forceEventDuration ? t.end = z.getDefaultEventEnd(t.allDay, t.start) : t.end = null)
        }

        function b(t) {
            null == t.allDay && (t.allDay = !(t.start.hasTime() || t.end && t.end.hasTime())), t.allDay ? (t.start.stripTime(), t.end && t.end.stripTime()) : (t.start.hasTime() || (t.start = z.applyTimezone(t.start.time(0))), t.end && !t.end.hasTime() && (t.end = z.applyTimezone(t.end.time(0))))
        }
        ...
        function D(e, n, i) {
            function r(t, e) {
                return i ? P(t, e, i) : n.allDay ? G(t, e) : L(t, e)
            }
            var s, o, a, l, u, c, d = {};
        ...
        function C(e, n, i, r, s, o) {
            var a = z.getIsAmbigTimezone(),
                l = [];
            return r && !r.valueOf() && (r = null), s && !s.valueOf() && (s = null), t.each(e, function (e, u) {
                    ...
                    c = {
                        ...
                        allDay: i
                    }, S(d), n ? d.end = null : s && !d.end && (d.end = z.getDefaultEventEnd(d.allDay, d.start)), r && (d.start.add(r), d.end && d.end.add(r)), s && d.end.add(s), a && !d.allDay && (r || s) && (d.start.stripZone(), d.end && d.end.stripZone()), t.extend(u, o, d), Wt(u), l.push(function () {
                        t.extend(u, c), Wt(u)
                    })
                }),
                function () {
        ...
        function H(e) {
            var i, r = n.businessHours,
                ...
                o = z.getView();
            return r && (i = t.extend({}, s, "object" == typeof r ? r : {})), i ? (e && (i.start = null, i.end = null), E(y(i), o.start, o.end)) : []
        }

        function T(t, e) {
            var i = e.source || {},
                r = tt(e.constraint, i.constraint, n.eventConstraint),
                s = tt(e.overlap, i.overlap, n.eventOverlap);
            return k(t, r, s, e)
        }

        function x(e, n, i) {
            var r, s;
            return i && (r = t.extend({}, i, n), s = E(y(r))[0]), s ? T(e, s) : R(e)
        }
        ...
        function k(t, e, n, i) {
            var r, s, o, a, l, u;
            if (null != e) {
                for (r = I(e), s = !1, a = 0; a < r.length; a++)
                    if (M(r[a], t)) {
                        s = !0;
                        break
                    } if (!s) return !1
            }
            for (o = z.getPeerEvents(t, i), a = 0; a < o.length; a++)
                if (l = o[a], F(l, t)) {
                    if (n === !1) return !1;
                    if ("function" == typeof n && !n(l, i)) return !1;
                    if (i) {
                        if (u = tt(l.overlap, (l.source || {}).overlap), u === !1) return !1;
        ...
        function I(t) {
            return "businessHours" === t ? H() : "object" == typeof t ? E(y(t)) : v(t)
        }

        function M(t, e) {
            var n = t.start.clone().stripZone(),
                i = z.getEventEnd(t).stripZone();
        ...
        var z = this;
        z.isFetchNeeded = i, z.fetchEvents = r, z.addEventSource = a, z.removeEventSource = u, z.updateEvent = h, z.renderEvent = p, z.removeEvents = m, z.clientEvents = v, z.mutateEvent = D, z.normalizeEventDates = S, z.normalizeEventTimes = b;
        var N, B, V = z.reportEvents,
            O = {
                events: []
            },
            _ = [O],
        ...
        t.each((n.events ? [n.events] : []).concat(n.eventSources || []), function (t, e) {
            var n = l(e);
            n && _.push(n)
        }), z.getBusinessHoursEvents = H, z.isEventSpanAllowed = T, z.isExternalSpanAllowed = x, z.isSelectionSpanAllowed = R, z.getEventCache = function () {
            return j
        }
    }
    ...
    t.fn.fullCalendar = function (e) {
        ...
        return this.each(function (r, s) {
            ...
            "string" == typeof e ? l && t.isFunction(l[e]) && (o = l[e].apply(l, n), r || (i = o), "destroy" === e && a.removeData("fullCalendar")) : l || (l = new be(a, e), a.data("fullCalendar", l), l.render())
        }), i
    };
    var qt = ["header", "buttonText", "buttonIcons", "themeButtonIcons"];
    Zt.intersectRanges = B, Zt.applyAll = K, Zt.debounce = lt, Zt.isInt = ot, Zt.htmlEscape = et, Zt.cssToStr = it, Zt.proxy = at, Zt.capitaliseFirstLetter = rt, Zt.getOuterRect = w, Zt.getClientRect = S, Zt.getContentRect = b, Zt.getScrollbarWidths = E;
    var Jt = null;
    Zt.intersectRects = x, Zt.parseFieldSpecs = M, Zt.compareByFieldSpecs = F, Zt.compareByFieldSpec = z, Zt.flexibleCompare = N, Zt.computeIntervalUnit = V, Zt.divideRangeByDuration = _, Zt.divideDurationByDuration = A, Zt.multiplyDuration = Y, Zt.durationHasTime = j;
    ...
    var Kt, te, ee, ne = {}.hasOwnProperty,
        ie = /^\s*\d{4}-\d\d$/,
        re = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/,
        se = e.fn,
        oe = t.extend({}, se);
    Zt.moment = function () {
        return ut(arguments)
        ...
        var t = oe.clone.apply(this, arguments);
        return dt(this, t), this._fullCalendar && (t._fullCalendar = !0), t
    }, se.week = se.weeks = function (t) {
        var e = (this._locale || this._lang)._fullCalendar_weekCalc;
        return null == t && "function" == typeof e ? e(this) : "ISO" === e ? oe.isoWeek.apply(this, arguments) : oe.week.apply(this, arguments)
    }, se.time = function (t) {
        if (!this._fullCalendar) return oe.time.apply(this, arguments);
        ...
        var t;
        return this._ambigTime || (t = this.toArray(), this.utc(), te(this, t.slice(0, 3)), this._ambigTime = !0, this._ambigZone = !0), this
    }, se.hasTime = function () {
        return !this._ambigTime
    }, se.stripZone = function () {
        var t, e;
        return this._ambigZone || (t = this.toArray(), e = this._ambigTime, this.utc(), te(this, t), this._ambigTime = e || !1, this._ambigZone = !0), this
    }, se.hasZone = function () {
        return !this._ambigZone
    }, se.local = function () {
        var t = this.toArray(),
            e = this._ambigZone;
        return oe.local.apply(this, arguments), this._ambigTime = !1, this._ambigZone = !1, e && ee(this, t), this
    }, se.utc = function () {
        return oe.utc.apply(this, arguments), this._ambigTime = !1, this._ambigZone = !1, this
    }, t.each(["zone", "utcOffset"], function (t, e) {
        oe[e] && (se[e] = function (t) {
            return null != t && (this._ambigTime = !1, this._ambigZone = !1), oe[e].apply(this, arguments)
        })
    }), se.format = function () {
        var t = n(arguments);
        return arguments = i(arguments), this._fullCalendar && arguments[0] ? pt(this, arguments[0], t) : this._ambigTime ? gt(this, "YYYY-MM-DD", t) : this._ambigZone ? gt(this, "YYYY-MM-DD[T]HH:mm:ss", t) : oe.format.apply(this, arguments)
    }, se.toISOString = function () {
        return isJalaali = n(arguments), arguments = i(arguments), this._ambigTime ? gt(this, "YYYY-MM-DD", isJalaali) : this._ambigZone ? gt(this, "YYYY-MM-DD[T]HH:mm:ss", isJalaali) : oe.toISOString.apply(this, arguments)
    }, se.isWithin = function (t, e) {
        var n = ct([this, t, e]);
        return n[0] >= n[1] && n[0] < n[2]
    }, se.isSame = function (t, e) {
        var n;
        return this._fullCalendar ? e ? (n = ct([this, t], !0), oe.isSame.call(n[0], n[1], e)) : (t = Zt.moment.parseZone(t), oe.isSame.call(this, t) && Boolean(this._ambigTime) === Boolean(t._ambigTime) && Boolean(this._ambigZone) === Boolean(t._ambigZone)) : oe.isSame.apply(this, arguments)
    }, t.each(["isBefore", "isAfter"], function (t, e) {
        se[e] = function (t, n) {
            var i;
            return this._fullCalendar ? (i = ct([this, t]), oe[e].call(i[0], i[1], n)) : oe[e].apply(this, arguments)
        }
    }), Kt = "_d" in e() && "updateOffset" in e, te = Kt ? function (t, n) {
        t._d.setTime(Date.UTC.apply(Date, n)), e.updateOffset(t, !1)
    } : ht, ee = Kt ? function (t, n) {
        t._d.setTime(+new Date(n[0] || 0, n[1] || 0, n[2] || 0, n[3] || 0, n[4] || 0, n[5] || 0, n[6] || 0)), e.updateOffset(t, !1)
    } : ht;
    var ae = {
        t: function (t, e) {
            return gt(t, "a", e).charAt(0)
        },
        T: function (t, e) {
            return gt(t, "A", e).charAt(0)
        }
    ...
    var le = {
        ...
        ue = {};
    Zt.Class = Dt, Dt.extend = function () {
        var t, e, n = arguments.length;
        for (t = 0; n > t; t++) e = arguments[t], n - 1 > t && Ht(this, e);
        return Ct(this, e || {})
    }, Dt.mixin = function (t) {
        Ht(this, t)
    };
    var ce = Zt.Emitter = Dt.extend({
            callbackHash: null,
            on: function (t, e) {
            ...
            trigger: function (t) {
                ...
                return this.triggerWith(t, this, e),
                    this
            },
        ...
        de = Dt.extend({
            ...
            render: function () {
                ...
                this.el = t('<div class="fc-popover"/>').addClass(n.className || "").css({
                    ...
                    e.hide()
                }), n.autoHide && t(document).on("mousedown", this.documentMousedownProxy = at(this, "documentMousedown"))
            },
        ...
        he = Zt.CoordCache = Dt.extend({
            ...
            queryBoundingRect: function () {
                var t = y(this.els.eq(0));
                return t.is(document) ? void 0 : S(t)
            },
        ...
        ge = fe.extend({
            ...
            listenStart: function (t) {
                ...
                fe.prototype.listenStart.apply(this, arguments), this.computeCoords(), t ? (n = {
                    left: t.pageX,
                    top: t.pageY
                }, i = n, r && (e = w(r), i = R(i, e)), this.origHit = this.queryHit(i.left, i.top), r && this.options.subjectCenter && (this.origHit && (e = x(this.origHit, e) || e), i = k(e)), this.coordAdjust = I(i, n)) : (this.origHit = null, this.coordAdjust = null)
            },
            ...
            dragStart: function (t) {
                var e;
                fe.prototype.dragStart.apply(this, arguments), e = this.queryHit(t.pageX, t.pageY), e && this.hitOver(e)
            },
            drag: function (t, e, n) {
                var i;
                fe.prototype.drag.apply(this, arguments), i = this.queryHit(n.pageX, n.pageY), Tt(i, this.hit) || (this.hit && this.hitOut(), i && this.hitOver(i))
            },
            dragStop: function () {
                this.hitDone(), fe.prototype.dragStop.apply(this, arguments)
            },
            hitOver: function (t) {
            ...
            listenStop: function () {
                fe.prototype.listenStop.apply(this, arguments), this.origHit = null, this.hit = null, this.component.releaseHits()
            },
            scrollStop: function () {
                fe.prototype.scrollStop.apply(this, arguments), this.computeCoords()
            },
        ...
        pe = Dt.extend({
            ...
            start: function (e) {
                this.isFollowing || (this.isFollowing = !0, this.mouseY0 = e.pageY, this.mouseX0 = e.pageX, this.topDelta = 0, this.leftDelta = 0, this.isHidden || this.updatePosition(), t(document).on("mousemove", this.mousemoveProxy = at(this, "mousemove")))
            },
            stop: function (e, n) {
                function i() {
        ...
        me = Zt.Grid = Dt.extend({
            ...
            largeUnit: null,
            constructor: function (t) {
                this.view = t, this.isRTL = t.opt("isRTL"), this.isJalaali = t.opt("isJalaali"), this.elsByFill = {}, this.externalDragStartProxy = at(this, "externalDragStart")
            },
            ...
            diffDates: function (t, e) {
                return this.largeUnit ? P(t, e, this.largeUnit) : L(t, e)
            },
            ...
            dayMousedown: function (t) {
                var e, n, i = this,
                    ...
                    o = new ge(this, {
                        ...
                        hitOver: function (t, r, o) {
                            o && (e = r ? t : null, s && (n = i.computeSelection(i.getHitSpan(o), i.getHitSpan(t)), n ? i.renderSelection(n) : n === !1 && d()))
                        },
                        hitOut: function () {
                            e = null, n = null, i.unrenderSelection(), h()
                        },
                        listenStop: function (t) {
                            e && r.triggerDayClick(i.getHitSpan(e), i.getHitEl(e), t), n && r.reportSelection(n, t), h()
                        }
                    });
                o.mousedown(t)
            },
            ...
            getDayClasses: function (t) {
                var e = this.view,
                    n = e.calendar.getNow(),
                    i = ["fc-" + Xt[t.day()]];
                return 1 == e.intervalDuration.as("months") && (this.isJalaali ? t.jMonth() != e.intervalStart.jMonth() : t.month() != e.intervalStart.month()) && i.push("fc-other-month"), t.isSame(n, "day") ? i.push("fc-today", e.highlightStateClass) : n > t ? i.push("fc-past") : i.push("fc-future"), i
            }
        });
    me.mixin({
        mousedOverSeg: null,
            ...
            var n, i = this,
                ...
                u = new ge(r, {
                    ...
                    dragStart: function (e) {
                        i.triggerSegMouseout(t, e), i.segDragStart(t, e), r.hideEvent(a)
                    },
                    hitOver: function (e, o, u) {
                        t.hit && (u = t.hit), n = i.computeEventDrop(u.component.getHitSpan(u), e.component.getHitSpan(e), a), n && !s.isEventSpanAllowed(i.eventToSpan(n), a) && (d(), n = null), n && r.renderDrag(n, t) ? l.hide() : l.show(), o && (n = null)
                    },
                    hitOut: function () {
                        r.unrenderDrag(), l.show(), n = null
                    },
                    hitDone: function () {
                        h()
                    },
                    dragStop: function (e) {
                        l.stop(!n, function () {
                            r.unrenderDrag(), r.showEvent(a), i.segDragStop(t, e), n && r.reportEventDrop(a, n, this.largeUnit, o, e)
                        })
                    },
                    listenStop: function () {
                        l.stop()
        ...
        listenToExternalDrag: function (t, e, n) {
            var i, r = this,
                ...
                a = new ge(this, {
                    ...
                    hitOver: function (t) {
                        i = r.computeExternalDrop(t.component.getHitSpan(t), o), i && !s.isExternalSpanAllowed(r.eventToSpan(i), i, o.eventProps) && (d(), i = null), i && r.renderDrag(i)
                    },
                    hitOut: function () {
                        i = null
                    },
                    ...
                    dragStop: function () {
                        i && r.view.reportExternalDrop(o, i, t, e, n)
                    },
                    listenStop: function () {
                ...
                c = new ge(this, {
                    ...
                    hitOver: function (e, a, c) {
                        var h = r.getHitSpan(c),
                            f = r.getHitSpan(e);
                        i = n ? r.computeEventStartResize(h, f, l) : r.computeEventEndResize(h, f, l), i && (o.isEventSpanAllowed(r.eventToSpan(i), l) ? i.start.isSame(l.start) && i.end.isSame(u) && (i = null) : (d(), i = null)), i && (s.hideEvent(l), r.renderEventResize(i, t))
                    },
                    hitOut: function () {
                        i = null
                    },
                    hitDone: function () {
                        r.unrenderEventResize(), s.showEvent(l), h()
                    },
                    dragStop: function (e) {
                        r.segResizeStop(t, e), i && s.reportEventResize(l, i, this.largeUnit, a, e)
                    }
                });
            c.mousedown(e)
        },
        ...
        invertRanges: function (t) {
            var e, n, i = this.view,
                ...
                o = [],
                a = r;
            for (t.sort(Ft), e = 0; e < t.length; e++) n = t[e], n.start > a && o.push({
                start: a,
                end: n.start
            }), a = n.end;
            return s > a && o.push({
        ...
        compareEventSegs: function (t, e) {
            return t.eventStartMS - e.eventStartMS || e.eventDurationMS - t.eventDurationMS || e.event.allDay - t.event.allDay || F(t.event, e.event, this.view.eventOrderSpecs)
        }
    }), Zt.isBgEvent = Rt, Zt.dataAttrPrefix = "";
    var ve = Zt.DayTableMixin = {
            breakOnWeeks: !1,
            dayDates: null,
            dayIndices: null,
            daysPerRow: null,
            ...
            sliceRangeByDay: function (t) {
                ...
                for (e = 0; e < this.rowCnt; e++)
                    for (n = e * a, i = n + a - 1, r = n; i >= r; r++) s = Math.max(u, r), o = Math.min(c, r), s = Math.ceil(s), o = Math.floor(o), o >= s && d.push({
                        row: e,
            ...
            renderHeadDateCellHtml: function (t, e, n) {
                var i = this.view;
                return '<th class="fc-day-header ' + i.widgetHeaderClass + " fc-" + Xt[t.day()] + '"' + (1 == this.rowCnt ? ' data-date="' + t.format("YYYY-MM-DD", this.isJalaali) + '"' : "") + (e > 1 ? ' colspan="' + e + '"' : "") + (n ? " " + n : "") + ">" + et(t.format(this.colHeadFormat, this.isJalaali)) + "</th>"
            },
            ...
            renderBgCellHtml: function (t, e) {
                ...
                return i.unshift("fc-day", n.widgetContentClass), '<td class="' + i.join(" ") + '" data-date="' + t.format("YYYY-MM-DD", this.isJalaali) + '"' + (e ? " " + e : "") + "></td>"
            },
        ...
        ye = Zt.DayGrid = me.extend(ve, {
            ...
            renderDates: function (t) {
                ...
                for (this.el.html(o), this.rowEls = this.el.find(".fc-row"), this.cellEls = this.el.find(".fc-day"), this.rowCoordCache = new he({
                        els: this.rowEls,
                        isVertical: !0
            ...
            renderNumberCellHtml: function (t) {
                var e;
                return this.view.dayNumbersVisible ? (e = this.getDayClasses(t), e.unshift("fc-day-number"), '<td class="' + e.join(" ") + '" data-date="' + t.format(this.isJalaali) + '">' + (this.isJalaali ? r(t.jDate()) : t.date()) + "</td>") : "<td/>"
            },
            computeEventTimeFormat: function () {
    ...
    ye.mixin({
        ...
        renderSegRow: function (e, n) {
            function i(e) {
                for (; e > o;) c = (v[r - 1] || [])[o], c ? c.attr("rowspan", parseInt(c.attr("rowspan") || 1, 10) + 1) : (c = t("<td/>"), a.append(c)), m[r][o] = c, v[r][o] = c, o++
            }
            ...
            for (r = 0; f > r; r++) {
                if (s = h[r], o = 0, a = t("<tr/>"), p.push([]), m.push([]), v.push([]), s)
                    for (l = 0; l < s.length; l++) {
                        for (u = s[l], i(u.leftCol), c = t('<td class="fc-event-container"/>').append(u.el), u.leftCol != u.rightCol ? c.attr("colspan", u.rightCol - u.leftCol + 1) : v[r][o] = c; o <= u.rightCol;) m[r][o] = c, p[r][o] = u, o++;
                        a.append(c)
                    }
        ...
        buildSegLevels: function (t) {
            ...
            for (this.sortEventSegs(t), e = 0; e < t.length; e++) {
                for (n = t[e], i = 0; i < r.length && Nt(n, r[i]); i++);
                n.level = i, (r[i] || (r[i] = [])).push(n)
            }
        ...
        limitRow: function (e, n) {
            function i(i) {
                for (; i > E;) u = w.getCellSegs(e, E, n), u.length && (h = s[n - 1][E], y = w.renderMoreLink(e, E, u), v = t("<div/>").append(y), h.append(v), b.push(v[0])), E++
            }
            var r, s, o, a, l, u, c, d, h, f, g, p, m, v, y, w = this,
                S = this.rowStructs[e],
                b = [],
                E = 0;
            if (n && n < S.segLevels.length) {
                for (r = S.segLevels[n - 1], s = S.cellMatrix, o = S.tbodyEl.children().slice(n).addClass("fc-limited").get(), a = 0; a < r.length; a++) {
                    ...
                    if (c) {
                        for (h = s[n - 1][l.leftCol], f = h.attr("rowspan") || 1, g = [], p = 0; p < d.length; p++) m = t('<td class="fc-more-cell"/>').attr("rowspan", f), u = d[p], y = this.renderMoreLink(e, l.leftCol + p, [l].concat(u)), v = t("<div/>").append(y), m.append(v), g.push(m[0]), b.push(m[0]);
        ...
        showSegPopover: function (t, e, n, i) {
            ...
            }, this.isRTL ? s.right = l.offset().left + l.outerWidth() + 1 : s.left = l.offset().left - 1, this.segPopover = new de(s), this.segPopover.show()
        },
    ...
    var we = Zt.TimeGrid = me.extend(ve, {
        slotDuration: null,
        snapDuration: null,
        snapsPerSlot: null,
        minTime: null,
        ...
        renderDates: function () {
            this.el.html(this.renderHtml()), this.colEls = this.el.find(".fc-day"), this.slatEls = this.el.find(".fc-slats tr"), this.colCoordCache = new he({
                els: this.colEls,
                isHorizontal: !0
        ...
        computeLabelInterval: function (t) {
            var n, i, r;
            for (n = Be.length - 1; n >= 0; n--)
                if (i = e.duration(Be[n]), r = A(i, t), ot(r) && r > 1) return i;
            return e.duration(t)
        },
        computeEventTimeFormat: function () {
        ...
        sliceRangeByTimes: function (t) {
            ...
            }, e = B(t, r), e && (e.dayIndex = n, s.push(e));
            return s
        },
    ...
    we.mixin({
        ...
        computeFgSegHorizontals: function (t) {
            var e, n, i;
            if (this.sortEventSegs(t), e = Lt(t), Gt(e), n = e[0]) {
                for (i = 0; i < n.length; i++) Pt(n[i]);
    ...
    var Se = Zt.View = Dt.extend({
            ...
            computeRange: function (t) {
                var e = V(this.intervalDuration),
                    n = t.clone().startOf(ft(e, this.isJalaali));
                if (!this.isJalaali || "year" !== e && "month" !== e) var i = n.clone().add(this.intervalDuration);
                else var i = n.clone().add(1, ft(e, this.isJalaali));
                var r, s;
                return /year|month|week|day/.test(e) ? (n.stripTime(), i.stripTime()) : (n.hasTime() || (n = this.calendar.time(0)), i.hasTime() || (i = this.calendar.time(0))), r = n.clone(), r = this.skipHiddenDays(r), s = i.clone(), s = this.skipHiddenDays(s, -1, !0), {
                    intervalUnit: e,
                    intervalStart: n,
                    intervalEnd: i,
                    start: r,
            ...
            formatRange: function (t, e, n) {
                var i = t.end;
                return i.hasTime() || (i = i.clone().subtract(1)), yt(t.start, i, e, n, this.opt("isRTL"), this.opt("isJalaali"))
            },
            ...
            isEventDraggable: function (t) {
                var e = t.source || {};
                return tt(t.startEditable, e.startEditable, this.opt("eventStartEditable"), t.editable, e.editable, this.opt("editable"))
            },
            ...
            documentMousedown: function (e) {
                var n;
                this.isSelected && this.opt("unselectAuto") && T(e) && (n = this.opt("unselectCancel"), n && t(e.target).closest(n).length || this.unselect(e))
            },
        ...
        be = Zt.Calendar = Dt.extend({
            ...
            initOptions: function (t) {
                var e, n, i, r;
                t = l(t), e = t.lang, n = Ee[e], n || (e = be.defaults.lang, n = Ee[e] || {}), i = tt(t.isRTL, n.isRTL, be.defaults.isRTL), r = i ? be.rtlDefaults : {}, this.dirDefaults = r, this.langDefaults = n, this.overrides = t, this.options = a([be.defaults, r, n, t]), At(this.options), this.viewSpecCache = {}
            },
            ...
            buildViewSpec: function (t) {
                for (var n, i, r, s, o = this.overrides.views || {}, l = [], u = [], c = [], d = t; d;) n = Ut[d], i = o[d], d = null, "function" == typeof n && (n = {
                    "class": n
                }), n && (l.unshift(n), u.unshift(n.defaults || {}), r = r || n.duration, d = d || n.type), i && (c.unshift(i), r = r || i.duration, d = d || i.type);
                return n = Z(l), n.type = t, n["class"] ? (r && (r = e.duration(r), r.valueOf() && (n.duration = r, s = V(r), 1 === r.as(s) && (n.singleUnit = s, c.unshift(o[s] || {})))), n.defaults = a(u), n.overrides = a(c), this.buildViewSpecOptions(n), this.buildViewSpecButtonText(n, t), n) : !1
            },
            buildViewSpecOptions: function (t) {
                t.options = a([be.defaults, t.defaults, this.dirDefaults, this.langDefaults, this.overrides, t.overrides]), At(t.options)
            },
            buildViewSpecButtonText: function (t, e) {
                ...
                t.buttonTextOverride = n(this.overrides) || t.overrides.buttonText, t.buttonTextDefault = n(this.langDefaults) || n(this.dirDefaults) || t.defaults.buttonText || n(be.defaults) || (t.duration ? this.humanizeDuration(t.duration) : null) || e
            },
    ...
    var Ee = Zt.langs = {};
    Zt.datepickerLang = function (e, n, i) {
        var r = Ee[e] || (Ee[e] = {});
    ...
    }, Zt.lang = function (e, n) {
        var i, r;
        i = Ee[e] || (Ee[e] = {}), n && (i = Ee[e] = a([i, n])), r = Yt(e), t.each(Ce, function (t, e) {
            null == i[t] && (i[t] = e(r, i))
        }), be.defaults.lang = e
    };
    var De = {
    ...
    Zt.lang("en", be.englishDefaults), Zt.sourceNormalizers = [], Zt.sourceFetchers = [];
    var Te = {
            dataType: "json",
            cache: !1
        },
        xe = 1;
    be.prototype.getPeerEvents = function (t, e) {
        var n, i, r = this.getEventCache(),
            s = [];
        for (n = 0; n < r.length; n++) i = r[n], e && e._id === i._id || s.push(i);
        return s
    };
    var Re = Zt.BasicView = Se.extend({
            dayGridClass: ye,
            dayGrid: null,
            dayNumbersVisible: !1,
        ...
        ke = {
            renderHeadIntroHtml: function () {
                var t = this.view;
                return t.weekNumbersVisible ? '<th class="fc-week-number ' + t.widgetHeaderClass + '" ' + t.weekNumberStyleAttr() + "><span>" + et(t.opt("weekNumberTitle")) + "</span></th>" : ""
            },
            renderNumberIntroHtml: function (t) {
                var e = this.view;
    ...
    var Me = Zt.AgendaView = Se.extend({
            timeGridClass: we,
            timeGrid: null,
            dayGridClass: ye,
            dayGrid: null,
            ...
            setHeight: function (t, e) {
                var n, i;
                null === this.bottomRuleHeight && (this.bottomRuleHeight = this.bottomRuleEl.outerHeight()), this.bottomRuleEl.hide(), this.scrollerEl.css("overflow", ""), v(this.scrollerEl), c(this.noScrollRowEls), this.dayGrid && (this.dayGrid.removeSegPopover(), n = this.opt("eventLimit"), n && "number" != typeof n && (n = Ne), n && this.dayGrid.limitRows(n)), e || (i = this.computeScrollerHeight(t), m(this.scrollerEl, i) ? (u(this.noScrollRowEls, E(this.scrollerEl)), i = this.computeScrollerHeight(t), this.scrollerEl.height(i)) : (this.scrollerEl.height(i).css("overflow", "hidden"), this.bottomRuleEl.show()))
            },
        ...
        Fe = {
            renderHeadIntroHtml: function () {
                var t, e = this.view;
                return e.opt("weekNumbers") ? (t = this.start.format(e.opt("smallWeekFormat")), '<th class="fc-axis fc-week-number ' + e.widgetHeaderClass + '" ' + e.axisStyleAttr() + "><span>" + et(t) + "</span></th>") : '<th class="fc-axis ' + e.widgetHeaderClass + '" ' + e.axisStyleAttr() + "></th>"
            },
            renderBgIntroHtml: function () {
                var t = this.view;
        ...
        ze = {
            renderBgIntroHtml: function () {
                var t = this.view;
                return '<td class="fc-axis ' + t.widgetContentClass + '" ' + t.axisStyleAttr() + "><span>" + (t.opt("allDayHtml") || et(t.opt("allDayText"))) + "</span></td>"
            },
            renderIntroHtml: function () {
                var t = this.view;
                return '<td class="fc-axis" ' + t.axisStyleAttr() + "></td>"
